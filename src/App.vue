      ...
      <form action="#" method="GET" @submit="formValidate" id="form">
        <fieldset title="contac info" form="form">
          ...
          >
            ...
            <p class="error-text" v-if="item.show">{{ item.errorText }}</p>
          </div>
        </fieldset>
...
export default {
  ...
  data() {
    return {
      headingBold: "Try it free 7 days",
      headingThin: "then $20/mo. thereafter",
      formInputs: [
        {
          id: 1,
        ...
        },
        {
          ...
          inputType: "text",
          errorText: "Look like this is not an email",
          idName: "email",
          value: "",
          show: false,
          validate: false
...
#app {
  ...
  .heading {
    ...
    text-align: center;
    color: white;
    box-shadow: 0 7px 3px 0 darken($color: $red, $amount: 5);
    @include resp("s") {
